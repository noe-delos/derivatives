...
export function Header({ showMenuButton, onMenuClick }: HeaderProps) {
  ...
  return (
    <header className="sticky top-0 z-50 w-full bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800">
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent className="w-56" align="end" forceMount>
            ...
            {(user?.role === 'admin' || user?.role === 'moderator') && (
              <>
                <DropdownMenuSeparator />
                <DropdownMenuItem onClick={() => router.push('/backoffice')}>
            ...
            {process.env.NODE_ENV === 'development' && (
              <DropdownMenuItem disabled>
                <span className="text-xs text-gray-500">Role: {user?.role || 'undefined'}</span>
              </DropdownMenuItem>
            )}
            <DropdownMenuSeparator />
